...
public class ActivityGame extends Activity implements OnItemClickListener,
    ...
    private void initFilds() {
        ...
        if ((sPref.getInt("LevelStrong", 0) == 1)
            ...
            imageAdapterUser.initArrayLow(fildsOfGame.fieldScreenShot.mas);
        } else {
            imageAdapterUser.initArray(fildsOfGame.fieldScreenShot.mas);
        }
        ...
        if ((sPref.getInt("LevelStrong", 0) == 1)
                || (sPref.getInt("LevelStrong", 0) == 2)) {
            imageAdapterComp.initArrayLow(fildsOfGame.fieldShotUser.mas);
        } else {
            imageAdapterComp.initArray(fildsOfGame.fieldShotUser.mas);
        }
